...
namespace Automation.Core.DataAccessAbstractions
{
    public interface ITestControllerRepo
    {
        ...
        void CreateController1Map(int? userId, ModuleController controller1, int refId);
        ...
        void DeleteController1Map(int? userId, string moduleId, int refId);
        ModuleController_Map GetMappedModuleData(int? userId, ModuleController controller1, int refId);
        List<string> GetAllModuleID();

        TestController_Map GetMappedTestControllerData(int? userId, TestController controller2, int refId);
        void CreateController2(TestController controller2);
        void CreateController2Map(int? userId,TestController controller2, int refId);
        ...
        void DeleteController2Map(int? userId, string testCaseID, int refId);
